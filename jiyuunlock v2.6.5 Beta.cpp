...
void unloadHook(DWORD pid) {
     logger.Log("INFO","Suspended process " + std::to_string(pid));
     Sleep(100);
     logger.Log("INFO","Resume process " + std::to_string(pid));
}
